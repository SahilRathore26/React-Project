    ...
    <div>
      {listData.map((item) => (
        <div
          ...
          className="flex justify-between border-b-1 border-gray-300 m-4 p-4"
        >
          ...
          <div>
            <button
              className="absolute bg-black text-white rounded-lg w-18 p-2 mt-[120px] place-items-center cursor-pointer "
            ...
            <img
              ...
              className="rounded-lg w-[156px] h-[144px] object-cover"
            />
          </div>
        </div>
      ))}
